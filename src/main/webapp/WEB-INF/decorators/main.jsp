...
<c:choose>
	...
	<c:otherwise>
		<p class="navbar-text pull-right">
			...
			<ul class="nav">
				...
				<c:url var="h2Url" value="/h2"/>
				<li><a href="${h2Url}">Database</a></li>
			</ul>
			</div>
		</div>
	</div>
	...
	<div id="footer">
	<div class="container">
		<p class="muted credit">Visit the <a href="http://projects.spring.io/spring-security/">Spring Security</a> site to learn more.</p>
	</div>
	</div>
</body>
</html>
